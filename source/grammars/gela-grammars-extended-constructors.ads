...
package Gela.Grammars.Extended.Constructors is

   type Constructor is new Gela.Grammars.Constructors.Constructor with private;
...
private
   ...
   type Constructor is new Gela.Grammars.Constructors.Constructor with record
