...
package body Anagram.Grammars.Parser_Utils is
   ...
   is
      function To_Production_List
        ...
        return Anagram.Grammars.Constructors.Production_List;

      procedure To_Production
        (Production : Production_Access;
         Result : in out Anagram.Grammars.Constructors.Production);
      ...
      procedure To_Production
        (Production : Production_Access;
         Result     : in out Anagram.Grammars.Constructors.Production) is
      begin
         for Part of Production.Parts loop
            case Part.Data.Kind is
               ...
               when others =>
                  declare
                     List : Anagram.Grammars.Constructors.Production_List :=
      ...
      function To_Production_List
        (List   : Production_List_Access;
         ...
         return Anagram.Grammars.Constructors.Production_List
      is
         Result : Anagram.Grammars.Constructors.Production_List :=
           Constructor.Create_Production_List;
      begin
         for Production of List.Productions loop
            declare
               Item : Anagram.Grammars.Constructors.Production :=
